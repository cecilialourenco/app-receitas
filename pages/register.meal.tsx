      ...
      <section className="container">
        <div {...getRootProps({ className: "dropzone" })}>
          ...
          <p style={{ fontWeight: "bold" }}>
            Adicione uma imagem para a sua refeição (opcional)
          </p>
        </div>
      </section>
    );
        ...
        <div>
          <main>
            ...
            <p style={{ textAlign: "center", color: "#aaa" }}>
              E use para montar seu cardápio semanal
            </p>
            <Form className="g-3" ref={formRef}>
              ...
              <p style={{ fontWeight: "bold" }}>Refeição</p>
              <Form.Group className="mb-3">
                <Form.Control
                  type="text"
                  placeholder="Exemplos: café da manhã, almoço, lanche da tarde..."
